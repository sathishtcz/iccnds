...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'info.iccnds@gmail.com';
    $mail->Password   = 'qsbk fesa xbdn pkca'; // App Password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    // Email setup to admin
    $mail->setFrom('info.iccnds@gmail.com', 'ICCNDS Enquiry');
    $mail->addAddress('info.iccnds@gmail.com', 'ICCNDS Enquiry');
    ...
    $replyMail->Body = '
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <p>Warm regards,<br>ICCNDS 2025 Team</p>
        </div>
    ';
